...
class Loader {
	 ...
	 * @param int    $priority      The priority order of the function.
	 * @param int    $accepted_args The args of the function.
	 */
	public function add_shortcode( $tag, $component, $callback, $priority = 10, $accepted_args = 2 ) {
		$this->shortcodes = $this->_add( $this->shortcodes, $tag, $component, $callback, $priority, $accepted_args );
	}
